...
import { normalizeNewsMarkdown, safeMarkdownHref } from "../news.markdown";
...
export function NewsArticleBody({ body, className }: NewsArticleBodyProps) {
  const markdown = normalizeNewsMarkdown(body);

  return (
    <div
      className={cn(
        "news-article-prose space-y-4 [&>*:first-child]:mt-0",
        className
      )}
    >
